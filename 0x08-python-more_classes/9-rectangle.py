...
class Rectangle:
    ...
    def height(self, value):
        """setter of property for height of recyangle.
        Arguments:
            value (int): height
        Raises:
    ...
    def square(cls, size=0):
        """new rectangle instance can be returned.
        Arguments:
            cls: to iterate through class attributes.
            size (int, optional): size of rectangle (1 side).
        Returns:
    ...
    def __str__(self):
        """Display rectangle with the character # .
    ...
    def bigger_or_equal(rect_1, rect_2):
        """area of two rectangles and compares them.
        Arguments:
